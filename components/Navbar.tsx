      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
        ...
        >
          {navLinks.map((l) => (
            <a
              key={l.name}
              href={l.href}
              className="text-[11px] uppercase tracking-widest font-medium text-white/60 hover:text-white transition-colors duration-200"
            >
              {l.name}
            </a>
          ))}
        ...
        <div className="hidden sm:flex items-center gap-4">
          ...
          <a
            ...
            className="text-[11px] text-white/30 hover:text-white/55 transition-colors tracking-wide"
          >
            Ver no Airbnb
          </a>
          {/* WhatsApp CTA */}
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-terra inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider"
          >
            <svg
              viewBox="0 0 24 24"
